...
class SueterCliente extends StatelessWidget {
  const SueterCliente({super.key});
                                  ...
                                  children: [
                                    Column(children: [
                                      ...
                                      Padding(
                                        padding: const EdgeInsets.all(8.0),
                                        child: Text(
                                          'Stock disponible: ${sueters[index].stock}',
                                          style: const TextStyle(
                                            fontWeight: FontWeight.bold,
                                            color: Colors.grey,
                                          ),
                                                ...
                                                Carrito nuevoCarrito = Carrito(
                                                    ...
                                                    articuloNombre:
                                                        sueters[index]
                                                            .nombreArticulo,
                                                    precio:
                                                        sueters[index].precio,
                                                    stock: sueters[index].stock,
                                                    imagenUrl:
                                                        sueters[index].imagen);

...
class CamisaCliente extends StatelessWidget {
  const CamisaCliente({super.key});
              ...
              child: BlocBuilder<ArticuloBloc, ArticuloState>(
                builder: (context, state) {
                  if (state is ArticulosLoading) {
                    ...
                    var camisas = state.articulos
                        .where((art) =>
                            art.nombreArticulo.toLowerCase().contains('camisa'))
                        .toList();
                                ...
                                children: [
                                  Column(children: [
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.all(8.0),
                                      child: Text(
                                        'Stock disponible: ${camisas[index].stock}',
                                        style: const TextStyle(
                                          fontWeight: FontWeight.bold,
                                          color: Colors.grey,
                                        ),
                                            ...
                                            if (camisas[index].stock > 0) {
                                              ...
                                              Carrito nuevoCarrito = Carrito(
                                                  ...
                                                  articuloCarrito:
                                                      camisas[index].id!,
                                                  cantidad: 1,
                                                  articuloNombre: camisas[index]
                                                      .nombreArticulo,
                                                  precio: camisas[index].precio,
                                                  stock: camisas[index].stock,
                                                  imagenUrl:
                                                      camisas[index].imagen);
